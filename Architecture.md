...
Use the collection of the `ParserData` and `AnalysisData` object instances received via the `ReportData` object instance to generate a report in the wanted format.
...
- Data generated by the analyzer.
